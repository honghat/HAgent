...
# Stores credentials in ~/.hagent/.anthropic_oauth.json (our own file).

_OAUTH_CLIENT_ID = "9d1c250a-e61b-44d9-88ed-5944d1962f5e"
_OAUTH_TOKEN_URL = "https://console.anthropic.com/v1/oauth/token"
_OAUTH_REDIRECT_URI = "https://console.anthropic.com/oauth/code/callback"
_OAUTH_SCOPES = "org:create_api_key user:profile user:inference"
_HAGENT_OAUTH_FILE = get_hagent_home() / ".anthropic_oauth.json"
...
def read_hagent_oauth_credentials() -> Optional[Dict[str, Any]]:
    """Read Hagent-managed OAuth credentials from ~/.hagent/.anthropic_oauth.json."""
