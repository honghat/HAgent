...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs HagentAgentLoop with terminal tool only
...
Requires: pip install hagent-agent[yc-bench]
"""
...
from environments.agent_loop import HagentAgentLoop
...
class YCBenchEvalConfig(HagentAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends HagentAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(HagentAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The HagentAgentLoop then drives the
    ...
    async def setup(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                '  pip install "hagent-agent[yc-bench]"\n'
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs HagentAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our HagentAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the HagentAgentLoop
            # ----------------------------------------------------------
