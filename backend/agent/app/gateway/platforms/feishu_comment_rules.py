...
Config: ~/.hagent/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.hagent/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hagent_home()`` helper (HAGENT_HOME-aware and
...
RULES_FILE = get_hagent_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_hagent_home() / "feishu_comment_pairing.json"
