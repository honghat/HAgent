...
try:
    ...
    _HAGENT_VERSION = "0.0.0"

_APP_VERSION = _HAGENT_VERSION
_BOT_VERSION = _HAGENT_VERSION
_YUANBAO_INSTANCE_ID = str(HAGENT_INSTANCE_ID)  # single source: yuanbao_proto.HAGENT_INSTANCE_ID
