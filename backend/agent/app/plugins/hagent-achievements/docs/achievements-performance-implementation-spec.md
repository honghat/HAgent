...
- persisted runtime files:
  - `~/.hagent/plugins/hagent-achievements/state.json` (existing unlock state)
  - `~/.hagent/plugins/hagent-achievements/scan_snapshot.json` (new)
  - `~/.hagent/plugins/hagent-achievements/scan_checkpoint.json` (new)
