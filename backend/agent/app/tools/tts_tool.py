...
- Users can declare any number of named providers with ``type: command``
  under ``tts.providers.<name>`` in ``~/.hagent/config.yaml``. Hagent
...
Configuration is loaded from ~/.hagent/config.yaml under the 'tts:' key.
...
# ===========================================================================
# Config loader -- reads tts: section from ~/.hagent/config.yaml
# ===========================================================================
def _load_tts_config() -> Dict[str, Any]:
    """
    Load TTS configuration from ~/.hagent/config.yaml.
...
def _get_piper_voices_dir() -> Path:
    ...
    Resolves to ``~/.hagent/cache/piper-voices/`` under the active
...
def text_to_speech_tool(
    ...
    Reads provider/voice config from ~/.hagent/config.yaml (tts: section).
