...
Storage (``~/.hagent/auth/google_oauth.json``, chmod 0o600):
...
def _credentials_path() -> Path:
    return get_hagent_home() / "auth" / "google_oauth.json"
...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "  2. Set HAGENT_GEMINI_CLIENT_ID and HAGENT_GEMINI_CLIENT_SECRET in ~/.hagent/.env\n"
            "\n"
