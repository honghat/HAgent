"""
Cron job scheduling system for Hagent Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    hagent gateway install    # Install as a user service
    sudo hagent gateway install --system  # Linux servers: boot-time system service
    hagent gateway            # Or run in foreground
