...
- **Dataset (ours):** [HatNguyen/openthoughts-tblite](https://huggingface.co/datasets/HatNguyen/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `HatNguyen/terminal-bench-2`  | `HatNguyen/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
