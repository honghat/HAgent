...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("hagent")
        class HagentToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "hagent", "mistral", "llama3_json")
...
from environments.tool_call_parsers.hagent_parser import HagentToolCallParser  # noqa: E402, F401
