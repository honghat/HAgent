...
Inspired by: GroceryMind — production Hagent agent doing live web research
             across German grocery stores (firecrawl + hagent-agent)
"""
...
# Ensure hagent-agent root is on path
...
class WebResearchEnvConfig(HagentAgentEnvConfig):
...
class WebResearchEnv(HagentAgentBaseEnv):
    """
