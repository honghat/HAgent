...
async def main():
    ...
    async with async_playwright() as playwright:
        ...
        # Navigate to homepage first to establish session, then to thread
        ...
        if not textbox:
            ...
            body_preview = (await page.locator("body").inner_text())[:300]
            raise RuntimeError(
                f"Không tìm thấy ô nhập Messenger. URL={url} title={title} body={body_preview}"
            )
