...
Usage:
    hagent pairing list              # Show all pending + approved users
    hagent pairing approve <platform> <code>  # Approve a pairing code
    hagent pairing revoke <platform> <user_id> # Revoke user access
    hagent pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle hagent pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: hagent pairing {list|approve|revoke|clear-pending}")
        print("Run 'hagent pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "backend/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'hagent pairing list' to see pending codes.\n")
