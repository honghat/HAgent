"""
Skills configuration for Hagent Agent.
`hagent skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in backend/config.yaml under:
...
from hagent_cli.config import cfg_get, load_config, save_config
from hagent_cli.colors import Colors, color
from hagent_cli.platforms import PLATFORMS as _PLATFORMS
