...
Skins are defined as YAML files in ~/.hagent/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.hagent/skins/
...
Drop a YAML file in ``~/.hagent/skins/<name>.yaml`` following the schema above.
