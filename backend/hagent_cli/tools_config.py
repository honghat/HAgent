...
Saves per-platform tool configuration to ~/.hagent/config.yaml under
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in ("agent_browser", "browserbase"):
        ...
        _print_info("    Switch voices by setting tts.piper.voice in ~/.hagent/config.yaml")
        ...
        # to ~/.hagent/.env), then continues straight into PKCE. If they
