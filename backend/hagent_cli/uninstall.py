...
- Keep data: Remove code but keep ~/.hagent/ (configs, sessions, logs)
"""
...
def run_uninstall(args):
    ...
    Options:
    - Full uninstall: removes code + ~/.hagent/ (configs, data, logs)
    - Keep data: removes code but keeps ~/.hagent/ for future reinstall
    """
    ...
    try:
        if project_root.exists():
            # If the install is inside ~/.hagent/, just remove the hagent-agent subdir
    ...
    # 5. Optionally remove ~/.hagent/ data directory (and named profiles)
    if full_uninstall:
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  irm https://raw.githubusercontent.com/NousResearch/hagent-agent/main/scripts/install.ps1 | iex", Colors.DIM))
        else:
            print(color("  curl -fsSL https://raw.githubusercontent.com/NousResearch/hagent-agent/main/scripts/install.sh | bash", Colors.DIM))
        print()
