...
- Snapshot persisted at `~/.hagent/plugins/hagent-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hagent/plugins/hagent-achievements/scan_checkpoint.json`.
