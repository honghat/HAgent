# Hagent Achievements Performance Implementation Plan
...
- Snapshot persisted at `backend/plugins/hagent-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `backend/plugins/hagent-achievements/scan_checkpoint.json`.
