# Hagent Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `backend/plugins/hagent-achievements/state.json` (existing unlock state)
  - `backend/plugins/hagent-achievements/scan_snapshot.json` (new)
  - `backend/plugins/hagent-achievements/scan_checkpoint.json` (new)
