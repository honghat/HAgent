...
echo ""
echo "Next steps:"
echo "  1. Check logs: tail -f ${HOME}/.hagent/logs/gateway-autostart-output.log"
...
echo ""
echo "📚 Documentation:"
echo "   - ${HOME}/.hagent/plugins/platforms/SETUP_ZALO_FB.md"
echo "   - ${HOME}/.hagent/plugins/platforms/scripts/extract_cookies.sh"
echo ""

echo -e "${BLUE}=== GATEWAY LOGS ===${NC}"
tail -f "${HOME}/.hagent/logs/gateway-autostart-output.log" 2>/dev/null || \
