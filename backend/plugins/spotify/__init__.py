...
``_check_spotify_available()`` — when the user has not run ``hagent auth
spotify``, the tools remain registered (so they appear in ``hagent
...
The Spotify auth flow (``hagent auth spotify``), CLI plumbing, and docs
