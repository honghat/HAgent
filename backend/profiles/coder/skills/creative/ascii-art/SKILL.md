...
```bash
python3 -m pyfiglet "HAGENT" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HAGENT&font=Slant" | boxes -d stone
```
