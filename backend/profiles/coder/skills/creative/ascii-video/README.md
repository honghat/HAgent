...
Built for [Hagent Agent](https://github.com/NousResearch/hagent-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hagent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/hagent-agent/tree/main/skills/creative/ascii-video) via PR.
