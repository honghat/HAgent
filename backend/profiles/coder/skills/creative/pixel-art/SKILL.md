...
```python
import sys
sys.path.insert(0, "/home/teknium/.hagent/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.hagent/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hagent installs package this)
