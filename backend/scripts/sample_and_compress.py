...
DEFAULT_DATASETS = [
    ...
    "NousResearch/hagent-agent-megascience-sft1",
    "NousResearch/Hagent-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Hagent-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-hagent-agent"
]
