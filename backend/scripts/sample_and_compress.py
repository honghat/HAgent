...
DEFAULT_DATASETS = [
    "HatNguyen/swe-terminus-agent-glm-kimi-minimax",
    "HatNguyen/hagent-agent-megascience-sft1",
    "HatNguyen/Hagent-Agent-Thinking-GLM-4.7-SFT2",
    "HatNguyen/Hagent-Agent-Thinking-GLM-4.7-SFT1",
    "HatNguyen/terminal-tasks-glm-hagent-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "HatNguyen/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload HatNguyen/{output_name} {final_output}")
