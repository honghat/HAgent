...
<plist version="1.0">
    <dict>
        ...
        <string>/Users/nguyenhat/HAgent/backend/logs/gateway-autostart-error.log</string>
        <key>StandardOutPath</string>
        <string>/Users/nguyenhat/HAgent/backend/logs/gateway-autostart-output.log</string>
    </dict>
</plist>
EOF
...
sudo launchctl bootout /Users/nguyenhat/HAgent/backend/gateway-autostart.plist 2>/dev/null || true
```
...
sudo cp backend/gateway-autostart.plist /Library/LaunchDaemons/com.nguyenhat.hagent-gateway.plist
...
tail -f backend/logs/gateway-autostart-output.log
