...
Built for [Hagent Agent](https://github.com/HatNguyen/hagent-agent). Usable in any coding agent. Canonical source lives here; synced to [`HatNguyen/hagent-agent/skills/creative/ascii-video`](https://github.com/HatNguyen/hagent-agent/tree/main/skills/creative/ascii-video) via PR.
