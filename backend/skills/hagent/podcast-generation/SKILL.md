...
```bash
python backend/agent/app/skills/hagent/podcast-generation/scripts/generate.py \
  --script-file workspace/script-file.json \
  --output-file workspace/outputs/generated-podcast.mp3 \
  --transcript-file workspace/outputs/generated-podcast-transcript.md
```
...
python backend/agent/app/skills/hagent/podcast-generation/scripts/generate.py \
  ...
  --output-file workspace/outputs/ai-history-podcast.mp3 \
  --transcript-file workspace/outputs/ai-history-transcript.md
```
...
- Podcasts and transcripts are saved in `workspace/outputs/`
