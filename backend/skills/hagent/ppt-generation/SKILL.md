...
1. Read the image-generation skill: `backend/agent/app/skills/hagent/image-generation/SKILL.md`
...
```bash
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  --prompt-file workspace/slide-01-prompt.json \
  --output-file workspace/outputs/slide-01.jpg \
  --aspect-ratio 16:9
```
...
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  ...
  --reference-images workspace/outputs/slide-01.jpg \
  --output-file workspace/outputs/slide-02.jpg \
  --aspect-ratio 16:9
```
...
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  ...
  --reference-images workspace/outputs/slide-02.jpg \
  --output-file workspace/outputs/slide-03.jpg \
  --aspect-ratio 16:9

# Slide 4 references slide 3
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  --prompt-file workspace/slide-04-prompt.json \
  --reference-images workspace/outputs/slide-03.jpg \
  --output-file workspace/outputs/slide-04.jpg \
  --aspect-ratio 16:9
```
...
```bash
python backend/agent/app/skills/hagent/ppt-generation/scripts/generate.py \
  --plan-file workspace/presentation-plan.json \
  --slide-images workspace/outputs/slide-01.jpg workspace/outputs/slide-02.jpg workspace/outputs/slide-03.jpg \
  --output-file workspace/outputs/presentation.pptx
```
...
Read `backend/agent/app/skills/hagent/image-generation/SKILL.md` to understand how to generate images.
...
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  ...
  --output-file workspace/outputs/nova-slide-01.jpg \
  --aspect-ratio 16:9
```
...
python backend/agent/app/skills/hagent/image-generation/scripts/generate.py \
  ...
  --reference-images workspace/outputs/nova-slide-01.jpg \
  --output-file workspace/outputs/nova-slide-02.jpg \
  --aspect-ratio 16:9
```
...
python backend/agent/app/skills/hagent/ppt-generation/scripts/generate.py \
  ...
  --slide-images workspace/outputs/nova-slide-01.jpg workspace/outputs/nova-slide-02.jpg workspace/outputs/nova-slide-03.jpg workspace/outputs/nova-slide-04.jpg workspace/outputs/nova-slide-05.jpg \
  --output-file workspace/outputs/nova-presentation.pptx
```
...
- The PPTX file is saved in `workspace/outputs/`
