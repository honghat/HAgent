...
Control the user's Spotify account via the Hagent Spotify toolset (7 tools). Setup guide: https://hagent-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `hagent auth spotify` again.
