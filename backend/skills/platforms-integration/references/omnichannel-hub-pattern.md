...
| Task | Command |
|------|---------|
| Initialize hub | `python ~/.hagent/plugins/platforms/omnichannel/init.py` |
| Test hub | `python3 test_omnichannel.py ~/.hagent/omnichannel.env` |
...
| Setup wizard | `source ~/.hagent/omnichannel_setup.sh` |
...
- [~/.hagent/OMNICHANNEL_QUICK_START.md](../../OMNICHANNEL_QUICK_START.md) - Vietnamese quick start guide
- [~/.hagent/plugins/platforms/omnichannel/README.md](./README.md) - Full documentation
