...
This skill is designed for the Hagent agent. It uses Hagent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Hagent skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `backend/plans/` | `skill_view("plan")` |
