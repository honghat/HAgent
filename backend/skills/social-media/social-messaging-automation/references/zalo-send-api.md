...
- Cookie config: `backend/omnichannel.env`
- Contacts JSON: `backend/omnichannel_contacts.json`
- Main scripts: `backend/plugins/platforms/omnichannel/`
