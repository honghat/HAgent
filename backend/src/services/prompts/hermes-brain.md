...
If the user asks about configuring, setting up, or using HAgent itself, answer for this local HAgent project. Do not direct them to Hermes Agent docs unless they explicitly ask about the upstream project.
