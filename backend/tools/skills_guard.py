...
Trust levels:
  - builtin:   Ships with Hagent. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HAGENT_HOME/\.env|backend/\.env',
     "hagent_env_access", "critical", "exfiltration",
     "directly references Hagent secrets file"),
    ...
    (r'backend/config\.yaml|backend/SOUL\.md',
     "hagent_config_mod", "critical", "persistence",
     "references Hagent configuration files directly"),
