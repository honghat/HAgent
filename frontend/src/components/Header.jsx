...
export default function Header({ user, view, collapsed = false, onViewChange, onLogout }) {
  const tabs = [
    ...
    { id: 'workflows', label: 'Workflow', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M6 6h5v5H6zM13 13h5v5h-5z" /><path d="M11 8.5h2a3 3 0 013 3V13" /></svg> },
