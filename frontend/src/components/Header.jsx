...
export default function Header({ user, view, onViewChange, onLogout }) {
  const tabs = [
    ...
    { id: 'job-hunter', label: 'Kiếm Việc', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M9 6V5a2 2 0 012-2h2a2 2 0 012 2v1" /><path d="M3 9a2 2 0 012-2h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path d="M9 13h6" /></svg> },
