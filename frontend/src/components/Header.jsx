...
export default function Header({ user, view, onViewChange, onLogout }) {
  const tabs = [
    ...
    { id: 'kiem-viec', label: 'Kiếm Việc', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M9 6V5a2 2 0 012-2h2a2 2 0 012 2v1" /><path d="M3 9a2 2 0 012-2h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path d="M9 13h6" /></svg> },
    ...
    { id: 'english', label: 'English', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M5 8h9" /><path d="M7 5v3c0 4 3 7 7 8" /><path d="M12 8c-.5 3-2.5 5.5-6 8" /><path d="M16 19l3-7 3 7" /><path d="M17 17h4" /></svg> },
    ...
    { id: 'cv-jobs', label: 'CV Jobs', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M9 6V5a2 2 0 012-2h2a2 2 0 012 2v1" /><path d="M3 9a2 2 0 012-2h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path d="M9 13h6" /></svg> },
    ...
    { id: 'ports', label: 'Ports', icon: <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M4 17h16M4 12h16M4 7h16" /><path d="M8 7v10M16 7v10" /></svg> },
