...
SESSION_FILE = "/Users/nguyenhat/HAgent/backend/plugins/platforms/omnichannel/session/current.session"
...
async def init_zalo_qr_login():
    ...
    qr_path = "/Users/nguyenhat/HAgent/backend/plugins/platforms/omnichannel/auth/qr_{}.png".format(chat_id)
