#!/usr/bin/env python3
"""Build the Hagent Skills Index — a centralized JSON catalog of all skills.
...
`hagent skills search/install` can use it without hitting the GitHub API.
...
# Ensure HAGENT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Hagent Skills Index...", flush=True)
