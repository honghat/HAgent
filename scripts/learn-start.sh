...
export PATH="/Users/nguyenhat/HAgent/tts/.venv/bin:/opt/homebrew/bin:/usr/local/bin:$PATH"
if [ -f "${HATAI_PYTHON:-/Users/nguyenhat/HAgent/tts/.venv/bin/python}" ]; then
  PYTHON="${HATAI_PYTHON:-/Users/nguyenhat/HAgent/tts/.venv/bin/python}"
else
  PYTHON="python3"
fi
