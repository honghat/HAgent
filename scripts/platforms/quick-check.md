...
|----------|--------|----------|
| **Zalo** | ⚠️ Plugin-ready (credentials needed) | `$HAGENT_HOME/plugins/platforms/zalo/` |
| **Facebook Messenger** | ⚠️ Plugin-ready (Playwright) | `$HAGENT_HOME/plugins/platforms/facebook/` |
...
└── scripts/
    ├── extract_cookies.md  # Cookie extraction guide
...
chmod +x ../../scripts/platforms/setup-wizard.sh
../../scripts/platforms/setup-wizard.sh
```
...
echo "  1. Run: ../../scripts/platforms/setup-wizard.sh"
