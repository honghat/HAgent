...
const defaultHagentHome = path.resolve(__dirname, '..', 'backend');
const hagentHome = process.env.HAGENT_HOME || defaultHagentHome;
const pluginDir = path.join(hagentHome, 'plugins', 'platforms', 'omnichannel');
