...
OMNICHANNEL_ENV_FILE="${OMNICHANNEL_ENV_FILE:-$HAGENT_HOME/omnichannel.env}"
OMNICHANNEL_PLUGIN_DIR="${OMNICHANNEL_PLUGIN_DIR:-$HAGENT_HOME/plugins/platforms/omnichannel}"
...
# Lưu vào file config
echo "export ZALO_COOKIE_STRING='$ZALO_COOKIE_STRING'" >> "$OMNICHANNEL_ENV_FILE"

echo ""
echo "✓ Đã lưu cookie vào $OMNICHANNEL_ENV_FILE"
source "$OMNICHANNEL_ENV_FILE"
...
echo ""
echo "  cd $OMNICHANNEL_PLUGIN_DIR"
echo "  python3 test_omnichannel.py $OMNICHANNEL_ENV_FILE"
echo ""
echo "HOẶC chạy nhanh hơn:"
echo ""
echo "  source $OMNICHANNEL_ENV_FILE"
echo "  cd $OMNICHANNEL_PLUGIN_DIR"  
